...
// Tue Aug  4 17:29:06 2015 by ROOT version 5.34/28
...
#ifdef testlor_cxx
testlor::testlor(TTree *tree) : fChain(0) 
{
...
Int_t testlor::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t testlor::LoadTree(Long64_t entry)
{
...
void testlor::Show(Long64_t entry)
{
...
Int_t testlor::Cut(Long64_t entry)
{
